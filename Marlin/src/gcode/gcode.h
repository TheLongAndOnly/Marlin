 ...
 * G34  - Z Stepper automatic alignment using probe (Requires Z_STEPPER_AUTO_ALIGN)
 ...
 * M422 - Define position for Z Stepper automatic alignment using probe X<units> Y<units> A<axis> I<iterations> (Requires Z_STEPPER_AUTO_ALIGN)
